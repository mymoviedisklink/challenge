...
BOT_URL = "https://challenge-5j7w.onrender.com"

# Choose your LLM provider: "openai", "anthropic", "gemini", "deepseek", "groq", "ollama", "openrouter"
LLM_PROVIDER = "openai"

# Your API key (paste your key here)
LLM_API_KEY = "test"  # Local Qwen endpoint

# Model to use
LLM_MODEL = "Qwen3.6-35B-A3B"

# Custom OpenAI-compatible base URL for local model
OPENAI_BASE_URL = "http://103.42.50.229:8000/v1"
...
class OpenAIProvider(LLMProvider):
    def __init__(self, api_key: str, model: str = ""):
        ...
        # Support custom base URL for local models
        self.base_url = globals().get("OPENAI_BASE_URL", "https://api.openai.com/v1")
...
class BotClient:
    ...
    def tick(self, triggers):
        ...
        return self._request("POST", "/v1/tick", 15, {
            "now": datetime.now(timezone.utc).isoformat().replace('+00:00', 'Z'), "available_triggers": triggers
        })
